...
namespace ENode.Eventual2PC.Commands
{
        ...
        : Command<TAggregateRootId>, ITransactionInitiatorAddPreCommitFailedParticipantCommand
    {
        ...
        /// 事务发起方添加预提交失败的参与方
        /// </summary>
        public TransactionInitiatorAddPreCommitFailedParticipantCommandBase()
            : base()
        { }
        ...
        public TransactionInitiatorAddPreCommitFailedParticipantCommandBase(TAggregateRootId aggregateRootId, string transactionId, byte transactionType, string participantId, byte participantType)
