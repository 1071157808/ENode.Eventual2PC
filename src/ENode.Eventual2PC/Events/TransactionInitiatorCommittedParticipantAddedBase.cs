...
namespace ENode.Eventual2PC.Events
{
    ...
    [Serializable]
    public abstract class TransactionInitiatorCommittedParticipantAddedBase<TInitiator, TAggregateRootId>
        : DomainEvent<TAggregateRootId>
        , ITransactionInitiatorCommittedParticipantAdded<TInitiator>
        where TInitiator : AggregateRoot<TAggregateRootId>, ITransactionInitiator
    {
        /// <summary>
        /// 已提交的事务参与方已添加事件基类
        /// </summary>
        protected TransactionInitiatorCommittedParticipantAddedBase() { }
        ...
        protected TransactionInitiatorCommittedParticipantAddedBase(string transactionId, byte transactionType, TransactionParticipantInfo transactionParticipant)
        {
