...
namespace ENode.Eventual2PC.Events
{
    ...
    [Serializable]
    public abstract class TransactionInitiatorPreCommitSucceedParticipantAddedBase<TInitiator, TAggregateRootId>
        : DomainEvent<TAggregateRootId>
        , ITransactionInitiatorPreCommitSucceedParticipantAdded<TInitiator>
        where TInitiator : AggregateRoot<TAggregateRootId>, ITransactionInitiator
    {
        /// <summary>
        /// 预提交成功的事务参与方已添加事件基类
        /// </summary>
        protected TransactionInitiatorPreCommitSucceedParticipantAddedBase() { }
        ...
        protected TransactionInitiatorPreCommitSucceedParticipantAddedBase(string transactionId, byte transactionType, TransactionParticipantInfo transactionParticipant)
        {
